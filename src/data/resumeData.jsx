...
export const projectsData = [
  {
    ...
    brief: {
      ko: "디지털 에이전시에서 프론트엔드 개발자로 근무하며, 기업 웹사이트 구축 및 운영 업무를 담당하고 있습니다.",
    ...
    projects: [
      {
        title: {
          ...
          url: {
            ko: "https://www.samsungsem.com/kr/index.do",
